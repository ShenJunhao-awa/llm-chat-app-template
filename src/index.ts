...
【输出格式 - 重要】
- 安全：{"status":"pass"}
- 违规：{"status":"reject", "violations":[{"reason":"用2-6个字概括违规类型，如'人身攻击''辱骂家人''色情内容''广告刷屏'等，不要长篇大论", "violation_phrase":"原样抄写违规词句"}]}
- reason 必须是简短的违规类型标签，不要用句子
- 只返回JSON`;
